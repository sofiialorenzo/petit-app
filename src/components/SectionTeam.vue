...
<section class="py-14">
    ...
    <div class="mt-12">
        ...
        <li v-for="(item, idx) in team" :key="idx">
            ...
            <div class="mt-4">
            <h3 class="text-lg text-gray-700 font-semibold">{{ item.name }}</h3>
            <p class="text-purple-dark">{{ item.title }}</p>
            <div class="mt-3 flex gap-4 text-gray-400">
                <a target="_blank" :href="item.linkedin" class="hover:text-gray-500" aria-label="red social linkedin">
                ...
                <a target="_blank" :href="item.github" class="hover:text-gray-500" aria-label="red social github">
